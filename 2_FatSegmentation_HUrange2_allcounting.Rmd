...
### This Stockholm_trip_version removes loops. It outputs csv result files for 1D, 2D  and 3D estimates.
```{r}
...
### Image Directory ###
### dcmImage=readDICOMFile("/home/fme/Documents/work_on_the_go/rabbit_ct_body_composition/MetteHalc_rabbits/M93885/M93885_0335.dcm")
```{r}
dicom_path <- "C:\\Users\\XXX" ## put image directory
...
nifti_image_filename <- paste0(patientID, "_left_kidney_R2_1D_image")
nifti_mask_filename <- paste0(patientID, "_left_kidney_R2_1D_mask")
...
# Add patientID as prefix to the filenames
nifti_image_filename <- paste0(patientID, "_right_kidney_R2_1D_image")
nifti_mask_filename <- paste0(patientID, "_right_kidney_R2_1D_mask")
...
# Add patientID as prefix to the filenames
nifti_image_filename <- paste0(patientID, "_left_kidney_R2_2D_image")
nifti_mask_filename <- paste0(patientID, "_left_kidney_R2_2D_mask")
...
# Add patientID as prefix to the filenames
nifti_image_filename <- paste0(patientID, "_right_kidney_R2_2D_image")
nifti_mask_filename <- paste0(patientID, "_right_kidney_R2_2D_mask")
...
# Add patientID as prefix to the filenames
nifti_image_filename <- paste0(patientID, "_left_kidney_R2_3D_image")
nifti_mask_filename <- paste0(patientID, "_left_kidney_R2_3D_mask")
...
# Add patientID as prefix to the filenames
nifti_image_filename <- paste0(patientID, "_right_kidney_R2_3D_image")
nifti_mask_filename <- paste0(patientID, "_right_kidney_R2_3D_mask")
